<template>
  <div class="sticky top-0 relative bg-white z-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      ...
      >
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <NuxtLink to="/">
            <span class="sr-only">Frontrow</span>
            <img
              class="h-4 w-auto sm:h-6"
              src="~/assets/FrontrowDeeppurple.svg"
              alt="Frontrow"
              width="339.69"
              height="61.38"
            />
        ...
        <nav class="hidden md:flex space-x-10">
          ...
          >
            ...
            <transition
              ...
              leave-active-class="transition ease-in duration-150 delay-500"
              ...
              >
                ...
                >
                  ...
                  >
                    <a
                      href="#"
                      class="-m-3 p-3 flex items-start rounded-lg hover:bg-white"
                    >
                  ...
                  <div
                    class="px-5 py-5 bg-white space-y-6 sm:flex justify-center sm:space-y-0 sm:space-x-10 sm:px-8"
                  >
                    <div class="flow-root">
                      <a
                        href="#"
          ...
          <div class="pt-5 pb-6 px-5">
            ...
            <div class="mt-6">
              <nav class="grid gap-y-8">
                <a
                  href="#"
                  class="-m-3 p-3 flex items-center rounded-md hover:bg-white"
                >
                  <!-- Heroicon name: chart-bar -->
                  <svg
                    class="flex-shrink-0 h-6 w-6 text-primary-600"
