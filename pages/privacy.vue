    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <main>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at the Frontrow website
        ...
        <p>
          ...
          including but not limited to First Name, Last Name, Email address,
          Mobile phone number. The information that we request will be securely
          retained by us and used as described in this privacy policy.
        </p>

        <p>
          The app does use third party services that may collect information
          used to identify you or offer additional services including but not
          limited to payment options and hosting services.
        </p>
        ...
        <p>
          <a href="https://stripe.com/en-nl/privacy" target="_blank"
            >https://stripe.com/en-nl/privacy</a
          >
        </p>

        <h2 class="mt-4">Log Data</h2>
        <p>
        ...
        <h2 class="mt-4">Service Providers</h2>
        <p>
        ...
        <p class="mt-4">This policy is effective as of 2021-05-01.</p>

        <p class="mt-4">
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us at info@frontrow.tech.
        </p>
      </main>
    </div>
  </div>
